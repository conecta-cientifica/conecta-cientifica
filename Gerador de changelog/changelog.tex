...
\begin{document}
	...
	\begin{itemize} \setlength\itemsep{0em}
		...
		\item Incluir botão para página de recomendações de projetos.
		\item Estilização novas páginas de perfil.
		\item Ajustes nas páginas de feed e recomendação de projetos.
